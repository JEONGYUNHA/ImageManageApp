...
class RecommendThirdFragment: Fragment() {
    ...
    lateinit var model3: MyViewModel3
    ...
    override fun onCreateView(
        ...
        //viewModel 싱글톤으로 구현
        model3 = ViewModelProvider(activity as ViewModelStoreOwner)[MyViewModel3::class.java]
       ...
       // activity as RecommendActivity
        model3.checkDone.observe(viewLifecycleOwner,Observer<Int> {
