...
class RecommendForthFragment: Fragment() {
    ...
    lateinit var model4: MyViewModel4
    ...
    override fun onCreateView(
        ...
        //viewModel 싱글톤으로 구현
        model4 = ViewModelProvider(activity as ViewModelStoreOwner)[MyViewModel4::class.java]
        ...
        model4.checkDone.observe(viewLifecycleOwner,Observer<Int> {
